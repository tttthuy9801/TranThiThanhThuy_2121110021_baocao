...
class PostController extends Controller
{
    ...
    public function create()
    {
        ...
        foreach ($list as $item) {
            $html_type .= "<option value =''" . $item->name . "'>" . $item->type . "</option>";
        }
    ...
    public function store(StorePostRequest $request)
    {
        ...
        if ($post->save()) {
            ...
            $link->type = 'post';
            $link->save();
            return redirect()->route('post.index')->with('message', ['type' => 'success', 'mgs' => 'Thêm bài viết thành công']);
        } else {
            return redirect()->route('post.index')->with('message', ['type' => 'danger', 'mgs' => 'Thêm bài viết không thành công']);
        }
    }
    ...
    public function update(UpdatePostRequest $request, string $id)
    {
        ...
        if ($row->save()) {
            ...
            return redirect()->route('post.index')->with('message', ['type' => 'success', 'mgs' => 'Cập nhật bài viết thành công']);
        } else {
            return redirect()->route('post.index')->with('message', ['type' => 'danger', 'mgs' => 'Thêm bài viết không thành công']);
        }
    }
