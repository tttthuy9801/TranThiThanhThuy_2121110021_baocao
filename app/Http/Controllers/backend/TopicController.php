...
class TopicController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('topic.index')->with('message', ['type' => 'success', 'mgs' => 'Xóa sản phẩm khỏi CSDL thành công']);
    ...
    public function status($id)
    {
        ...
        $row->save();
        return redirect()->route('topic.index')->with('message', ['type' => 'success', 'mgs' => 'Thay đổi trạng thái sản phẩm thành công']);
    }
    ...
    public function restore($id)
    {
        ...
        $row->status = 2;
        $row->save();
        return redirect()->route('topic.trash')->with('message', ['type' => 'success', 'mgs' => 'Khôi phục sản phẩm thành công']);
    }
