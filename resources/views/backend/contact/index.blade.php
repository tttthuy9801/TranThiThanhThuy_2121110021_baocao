            ...
            @foreach ($list as $row)
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{ route('contact.edit',['contact' => $row ->id]) }}" class="btn btn-sm btn-primary" > <i class="fas fa-edit"></i></i></a>
                    <a href="{{ route('contact.show',['contact' => $row ->id]) }}" class="btn btn-sm btn-info "><i class="far fa-eye"></i></a>
