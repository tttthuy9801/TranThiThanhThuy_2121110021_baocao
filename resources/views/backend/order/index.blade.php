            ...
            @foreach ($list as $row)
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{ route('order.edit',['order' => $row ->id]) }}" class="btn btn-sm btn-primary" > <i class="fas fa-edit"></i></i></a>
                    <a href="{{ route('order.show',['order' => $row ->id]) }}" class="btn btn-sm btn-info "><i class="far fa-eye"></i></a>
